...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Teste de Leitura Individual 4º e 5º Anos') }}</div>
                    ...
                    <div class="card-body">
                        <div class="text-center"> <!-- Div centralizada horizontalmente -->
                            ...
                            <h1><span>Teste de Leitura Individual 4º e 5º Anos</span></h1>
                        </div>
                        <div>
                            <form method="get" action="{{ route('aluno.leitura') }}">
                                @csrf
                            ...
                            @if ($escolaId && count($alunosQuartoAno) > 0)
                                <form method="POST" action="{{ route('aluno.leiturapostTeste') }}">
                                    @csrf

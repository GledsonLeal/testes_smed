<?php
//classe nativa do laravel está em vendor/laravel/framework/src/iluminate/Auth/Notifications/VerifyEmail.php
...
class VerificarEmailNotification extends Notification
{
    ...
    protected function buildMailMessage($url)
    {
        return (new MailMessage)
            ...
            ->action(Lang::get('Verifique o endereço de e-mail'), $url)
